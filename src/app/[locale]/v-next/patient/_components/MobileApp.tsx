  ...
  return (
    <section className="vnp-section vnp-section--tint vnma" aria-labelledby="vnma-title">
      <style>{`
        ...
        .vnma__badges { display: flex; flex-wrap: wrap; gap: 12px; margin: 28px 0 0; }
        .vnma__badge {
          display: inline-flex; align-items: center; gap: 12px; padding: 11px 20px;
          border-radius: 14px; background: var(--color-dark-1); color: #fff;
          opacity: 0.92; cursor: default; position: relative;
        }
        .vnma__badge i { font-size: 24px; }
        .vnma__badge-sm { font-size: 10.5px; opacity: 0.7; line-height: 1; }
        .vnma__badge-lg { font-size: 16px; font-weight: 700; line-height: 1.2; }
        .vnma__badge-soon { position: absolute; top: -8px; right: -8px; font-size: 9.5px; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; color: var(--color-dark-1); background: var(--color-teal); padding: 3px 8px; border-radius: 999px; }
        ...
        .vnma__doc-chip { margin-left: auto; font-size: 9.5px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; color: var(--vnp-accent); background: var(--vnp-accent-soft); padding: 4px 8px; border-radius: 999px; }
        ...
        <div className="vnma__grid">
          <AnimatedSection direction="left">
            <div>
              ...
              <div className="vnma__badges">
                <span className="vnma__badge" title={t("comingSoonTooltip")}>
                  <i className="fab fa-apple" aria-hidden="true" />
                  <span>
                    <span className="vnma__badge-sm">{t("downloadOn")}</span><br />
                    <span className="vnma__badge-lg">{t("appStoreLabel")}</span>
                  </span>
                  <span className="vnma__badge-soon">{t("comingSoon")}</span>
                </span>
                <span className="vnma__badge" title={t("comingSoonTooltip")}>
                  <i className="fab fa-google-play" aria-hidden="true" />
                  <span>
                    <span className="vnma__badge-sm">{t("getItOn")}</span><br />
                    <span className="vnma__badge-lg">{t("googlePlayLabel")}</span>
                  </span>
                  <span className="vnma__badge-soon">{t("comingSoon")}</span>
                </span>
              </div>
                ...
                <div className="vnma__screen">
                  ...
                  {docs.map((d) => (
                    <div className="vnma__doc" key={d.name}>
                      ...
                      <span className="vnma__doc-chip">{t("comingSoon")}</span>
                    </div>
                  ))}
